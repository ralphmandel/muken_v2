_modifier_generic_knockback_lua = class({})

--------------------------------------------------------------------------------
-- Classifications
function _modifier_generic_knockback_lua:IsHidden()
	return true
end

function _modifier_generic_knockback_lua:IsPurgable()
	return false
end

function _modifier_generic_knockback_lua:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
--------------------------------------------------------------------------------
-- Initializations
function _modifier_generic_knockback_lua:OnCreated( kv )
	if IsServer() then
...
function _modifier_generic_knockback_lua:OnRefresh( kv )
	if not IsServer() then return end
end

function _modifier_generic_knockback_lua:OnDestroy( kv )
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Setter
function _modifier_generic_knockback_lua:SetEndCallback( func ) 
	self.EndCallback = func
end

--------------------------------------------------------------------------------
-- Modifier Effects
function _modifier_generic_knockback_lua:DeclareFunctions()
	local funcs = {
...
function _modifier_generic_knockback_lua:GetOverrideAnimation( params )
	if self.anim==1 then
...
--------------------------------------------------------------------------------
-- Status Effects
function _modifier_generic_knockback_lua:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion effects
function _modifier_generic_knockback_lua:UpdateHorizontalMotion( me, dt )
...
function _modifier_generic_knockback_lua:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function _modifier_generic_knockback_lua:UpdateVerticalMotion( me, dt )
	-- set time
...
function _modifier_generic_knockback_lua:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:Destroy()
	end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function _modifier_generic_knockback_lua:GetEffectName()
	if not IsServer() then return end
	if self.stun then
...
function _modifier_generic_knockback_lua:GetEffectAttachType()
	if not IsServer() then return end
