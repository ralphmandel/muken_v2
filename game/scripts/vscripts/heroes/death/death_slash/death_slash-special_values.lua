death_slash_special_values = class({})

function death_slash_special_values:IsHidden() return true end
function death_slash_special_values:IsPurgable() return false end

-- CONSTRUCTORS -----------------------------------------------------------

function death_slash_special_values:OnCreated(kv)
...
function death_slash_special_values:OnRefresh(kv)
end

function death_slash_special_values:OnRemoved()
end

function death_slash_special_values:AddCustomTransmitterData()
  return {
    ranks = self.ranks,
...
function death_slash_special_values:HandleCustomTransmitterData(data)
...
function death_slash_special_values:DeclareFunctions()
	local funcs = {
...
function death_slash_special_values:GetModifierOverrideAbilitySpecial(keys)
	local caster = self:GetCaster()
	local ability = keys.ability
	local value_name = keys.ability_special_value
	local value_level = keys.ability_special_level

	if ability:GetAbilityName() == "death_slash_1__slash" then
	...
	if ability:GetAbilityName() == "death_slash_2__sk2" then
		if value_name == "AbilityManaCost" then return 1 end
		if value_name == "AbilityCooldown" then return 1 end
    if value_name == "AbilityCastRange" then return 1 end
    if value_name == "AbilityCharges" then return 1 end
  ...
  if ability:GetAbilityName() == "death_slash_3__sk3" then
		if value_name == "AbilityManaCost" then return 1 end
		if value_name == "AbilityCooldown" then return 1 end
    if value_name == "AbilityCastRange" then return 1 end
    if value_name == "AbilityCharges" then return 1 end
  ...
  if ability:GetAbilityName() == "death_slash_4__sk4" then
		if value_name == "AbilityManaCost" then return 1 end
		if value_name == "AbilityCooldown" then return 1 end
    if value_name == "AbilityCastRange" then return 1 end
    if value_name == "AbilityCharges" then return 1 end
  ...
  if ability:GetAbilityName() == "death_slash_5__sk5" then
		if value_name == "AbilityManaCost" then return 1 end
		if value_name == "AbilityCooldown" then return 1 end
    if value_name == "AbilityCastRange" then return 1 end
    if value_name == "AbilityCharges" then return 1 end
  ...
  if ability:GetAbilityName() == "death_slash_u__sk6" then
		if value_name == "AbilityManaCost" then return 1 end
		if value_name == "AbilityCooldown" then return 1 end
    if value_name == "AbilityCastRange" then return 1 end
    if value_name == "AbilityCharges" then return 1 end
...
function death_slash_special_values:GetModifierOverrideAbilitySpecialValue(keys)
	local caster = self:GetCaster()
	local ability = keys.ability
	local value_name = keys.ability_special_value
	local value_level = keys.ability_special_level
  ...
  local mana_mult = (1 + ((ability_level - 1) * 0.1))
	...
	if ability:GetAbilityName() == "death_slash_5__smoke" then
...
function death_slash_special_values:LearnRank(skill_id, tier, path)
...
function death_slash_special_values:HasRank(skill_id, tier, path)
  for index, table in pairs(self.ranks) do
    if table.skill_id == skill_id and table.tier == tier and table.path == path then
...
function death_slash_special_values:UpdateData(data, value)
	self.data_props[data] = value
  self:SendBuffRefreshToClients()
end

function death_slash_special_values:GetBuffAmp()
  return 1 + self.data_props["buff_amp"]
end

function death_slash_special_values:GetDebuffAmp()
  return 1 + self.data_props["debuff_amp"]
end

function death_slash_special_values:GetPhysicalDamageAmp()
  return self.data_props["physical_damage"] * 0.01
end

function death_slash_special_values:GetMagicalDamageAmp()
  return self.data_props["magical_damage"] * 0.01
end

function death_slash_special_values:GetHolyDamageAmp()
  return self.data_props["holy_damage"] * 0.01
end

function death_slash_special_values:GetHealPower()
  return 1 + self.data_props["heal_power"]
end

function death_slash_special_values:CalcLuck(value)
