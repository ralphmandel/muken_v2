ancient_1_modifier_jump = class({})

function ancient_1_modifier_jump:IsHidden() return true end
function ancient_1_modifier_jump:IsPurgable() return false end
function ancient_1_modifier_jump:GetPriority() return MODIFIER_PRIORITY_SUPER_ULTRA end

-- CONSTRUCTORS -----------------------------------------------------------

function ancient_1_modifier_jump:OnCreated( kv )
...
function ancient_1_modifier_jump:OnRefresh( kv )
end

function ancient_1_modifier_jump:OnRemoved()
end

function ancient_1_modifier_jump:OnDestroy()
...
function ancient_1_modifier_jump:CheckState()
	local state = {
...
function ancient_1_modifier_jump:OnIntervalThink()
...
function ancient_1_modifier_jump:UpdateHorizontalMotion( me, dt )
	-- get current states
...
function ancient_1_modifier_jump:OnHorizontalMotionInterrupted()
	self:Destroy()
end
...
function ancient_1_modifier_jump:GetEffectName()
	return "particles/units/heroes/hero_tiny/tiny_toss_blur.vpcf"
end

function ancient_1_modifier_jump:GetEffectAttachType()
