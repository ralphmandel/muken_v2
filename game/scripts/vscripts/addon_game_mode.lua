...
function Precache( context )
  ...
  -- Particles can be precached individually or by folder
    ...
    PrecacheResource( "particle", "particles/generic/holy_orb_buff/holy_orb_buff.vpcf", context )
    ...
    PrecacheResource( "particle", "particles/vulture/rot/vulture_rot.vpcf", context )
    PrecacheResource( "particle", "particles/econ/items/effigies/status_fx_effigies/status_effect_aghs_standard_statue.vpcf", context )
